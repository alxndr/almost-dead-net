...
export default function About() {
  return <Layout className="aboutPage">
    ...
    <p>The content on this site is based on public information, with additional contributions from a variety of ndividuals.</p>
    <hr />
    ...
    <p>The site on <tt>lot.almost-dead.net</tt> is powered by <a href="https://lot.almost-dead.net/" title="JRAD Forum — The Lot">The Lot</a>, a forum powered by <a href="https://discourse.org" target="_blank" rel="noopener noreferrer">Discourse</a>, running on Google Cloud.</p>
